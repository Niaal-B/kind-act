"""
Django settings for santa_project project.
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-1(_cv_asccc1=ee0x--l&&h3m35ndxanp90^a)pl$3#@ukuyrw')
...
MIDDLEWARE = [
    ...
    'santa_project.middleware.DisableCSRFForAPI',  # Disable CSRF for API endpoints
...
ROOT_URLCONF = 'santa_project.urls'
...
WSGI_APPLICATION = 'santa_project.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.SessionAuthentication',  # Keep for admin if needed
    ],
...
# Disable CSRF for API views (since we're using SessionAuthentication for REST API)
...
# Groq API Key for Chat with Santa feature
